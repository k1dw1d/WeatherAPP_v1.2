        ...
        protected void onPostExecute(JSONObject json) {
            try {
                if(json != null){
                    ...
                    String sunrise = new SimpleDateFormat("hh:mm a").format(dr);
                    String sunset = new SimpleDateFormat("hh:mm a").format(ds);
                    //String sunrise = df.format(new Date(sysObj.getInt("sunrise")*1000)); //Lucreaza, dar nepaneatna cum
                    //String sunset = df.format(new Date(sysObj.getInt("sunset")*1000));
